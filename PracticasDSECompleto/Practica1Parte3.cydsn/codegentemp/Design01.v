...
module top ;
	...
	wire [0:0] tmpOE__ledSoftwareInterrupcionPWM_net;
	wire [0:0] tmpFB_0__ledSoftwareInterrupcionPWM_net;
	wire [0:0] tmpIO_0__ledSoftwareInterrupcionPWM_net;
	wire [0:0] tmpINTERRUPT_0__ledSoftwareInterrupcionPWM_net;
	electrical [0:0] tmpSIOVREF__ledSoftwareInterrupcionPWM_net;

	cy_psoc3_pins_v1_10
		#(.id("f97645e8-2386-4175-b7c3-7b542a8326af"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ledSoftwareInterrupcionPWM
		 (.oe(tmpOE__ledSoftwareInterrupcionPWM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ledSoftwareInterrupcionPWM_net[0:0]}),
		  .io({tmpIO_0__ledSoftwareInterrupcionPWM_net[0:0]}),
		  .siovref(tmpSIOVREF__ledSoftwareInterrupcionPWM_net),
		  .interrupt({tmpINTERRUPT_0__ledSoftwareInterrupcionPWM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ledSoftwareInterrupcionPWM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__botoncitoRegulador_net;
	wire [0:0] tmpIO_0__botoncitoRegulador_net;
	wire [0:0] tmpINTERRUPT_0__botoncitoRegulador_net;
	electrical [0:0] tmpSIOVREF__botoncitoRegulador_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		botoncitoRegulador
		 (.oe(tmpOE__botoncitoRegulador_net),
		  .y({1'b0}),
		  .fb({Net_201}),
		  .io({tmpIO_0__botoncitoRegulador_net[0:0]}),
		  .siovref(tmpSIOVREF__botoncitoRegulador_net),
		  .interrupt({tmpINTERRUPT_0__botoncitoRegulador_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__botoncitoRegulador_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- Mux start --
    if (1)
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_207 or Net_208 or Net_201)
        begin
            case (Net_201)
                1'b0 :  tmp__mux_1_reg = Net_207;
                1'b1 :  tmp__mux_1_reg = Net_208;
            endcase
        end
        assign Net_3 = tmp__mux_1_reg;
    end
    // -- Mux end --


	cy_clock_v1_0
		#(.id("8a530d38-52e6-4572-843f-3a973edba450"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1E+15"),
		  .is_direct(0),
