/*******************************************************************************
* File Name: convertidorAnalogicoDigital_theACLK.c
* Version 2.20
*
*  Description:
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_Start
********************************************************************************
*
* Summary:
...
void convertidorAnalogicoDigital_theACLK_Start(void) 
{
    ...
    convertidorAnalogicoDigital_theACLK_CLKEN |= convertidorAnalogicoDigital_theACLK_CLKEN_MASK;
	convertidorAnalogicoDigital_theACLK_CLKSTBY |= convertidorAnalogicoDigital_theACLK_CLKSTBY_MASK;
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_Stop
********************************************************************************
*
* Summary:
...
void convertidorAnalogicoDigital_theACLK_Stop(void) 
{
    ...
    convertidorAnalogicoDigital_theACLK_CLKEN &= (uint8)(~convertidorAnalogicoDigital_theACLK_CLKEN_MASK);
	convertidorAnalogicoDigital_theACLK_CLKSTBY &= (uint8)(~convertidorAnalogicoDigital_theACLK_CLKSTBY_MASK);
}
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_StopBlock
********************************************************************************
*
* Summary:
...
{
    if ((convertidorAnalogicoDigital_theACLK_CLKEN & convertidorAnalogicoDigital_theACLK_CLKEN_MASK) != 0u)
    {
        ...
        CLK_DIST_AMASK = convertidorAnalogicoDigital_theACLK_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = convertidorAnalogicoDigital_theACLK_CLKEN_MASK;
        CLK_DIST_AMASK = 0x00u;
#endif /* convertidorAnalogicoDigital_theACLK__CFG3 */

        /* Clear mask of bus clock. */
        CLK_DIST_BCFG2 &= (uint8)(~BCFG2_MASK);

        oldDivider = CY_GET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR, oldDivider);
#endif /* HAS_CLKDIST_LD_DISABLE */
    }
}
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_StandbyPower
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_SetDividerRegister
********************************************************************************
*
* Summary:
                                ...
                                
{
    ...
    uint8 currSrc = convertidorAnalogicoDigital_theACLK_GetSourceRegister();
    uint16 oldDivider = convertidorAnalogicoDigital_theACLK_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = convertidorAnalogicoDigital_theACLK_CLKEN & convertidorAnalogicoDigital_theACLK_CLKEN_MASK;
        ...
        if ((currSrc == (uint8)CYCLK_SRC_SEL_CLK_SYNC_D) && ((oldDivider == 0u) || (clkDivider == 0u)))
        {
            ...
            if (oldDivider == 0u)
            {
                ...
                CY_SET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR, clkDivider);
                convertidorAnalogicoDigital_theACLK_MOD_SRC &= (uint8)(~CYCLK_SSS);
            }
            else
            {
                /* Moving to SSS, set SSS which then ignores the divider and we can set     */
                /* it without bothering with the shadow load.                               */
                convertidorAnalogicoDigital_theACLK_MOD_SRC |= CYCLK_SSS;
                CY_SET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR, clkDivider);
            }
        }
        else
        {
            ...
            if (enabled != 0u)
            {
                ...
                if (((convertidorAnalogicoDigital_theACLK_MOD_SRC & CYCLK_SYNC) == 0u) || (clkDivider == 0u))
                {
#if HAS_CLKDIST_LD_DISABLE
                    CY_SET_REG16(CYREG_CLKDIST_WRK0, oldDivider);
                    CLK_DIST_LD = CYCLK_LD_DISABLE|CYCLK_LD_SYNC_EN|CYCLK_LD_LOAD;
            ...
            else
            {
                ...
                CY_SET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR, clkDivider);
				convertidorAnalogicoDigital_theACLK_CLKEN |= enabled;
            }
        }
    }
}
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_GetDividerRegister
********************************************************************************
*
* Summary:
...
{
    return CY_GET_REG16(convertidorAnalogicoDigital_theACLK_DIV_PTR);
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_SetModeRegister
********************************************************************************
*
* Summary:
...
{
    convertidorAnalogicoDigital_theACLK_MOD_SRC |= modeBitMask & (uint8)convertidorAnalogicoDigital_theACLK_MODE_MASK;
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_ClearModeRegister
********************************************************************************
*
* Summary:
...
{
    convertidorAnalogicoDigital_theACLK_MOD_SRC &= (uint8)(~modeBitMask) | (uint8)(~(uint8)(convertidorAnalogicoDigital_theACLK_MODE_MASK));
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_GetModeRegister
********************************************************************************
*
* Summary:
...
{
    return convertidorAnalogicoDigital_theACLK_MOD_SRC & (uint8)(convertidorAnalogicoDigital_theACLK_MODE_MASK);
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_SetSourceRegister
********************************************************************************
*
* Summary:
...
{
    uint16 currDiv = convertidorAnalogicoDigital_theACLK_GetDividerRegister();
    uint8 oldSrc = convertidorAnalogicoDigital_theACLK_GetSourceRegister();
        ...
        (clkSource == ((uint8)CYCLK_SRC_SEL_CLK_SYNC_D))) && (currDiv == 0u))
    {
        ...
        convertidorAnalogicoDigital_theACLK_MOD_SRC |= CYCLK_SSS;
        convertidorAnalogicoDigital_theACLK_MOD_SRC =
            (convertidorAnalogicoDigital_theACLK_MOD_SRC & (uint8)(~convertidorAnalogicoDigital_theACLK_SRC_SEL_MSK)) | clkSource;
    }
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_GetSourceRegister
********************************************************************************
*
* Summary:
...
{
    return convertidorAnalogicoDigital_theACLK_MOD_SRC & convertidorAnalogicoDigital_theACLK_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_SetPhaseRegister
********************************************************************************
*
* Summary:
...
{
    convertidorAnalogicoDigital_theACLK_PHASE = clkPhase & convertidorAnalogicoDigital_theACLK_PHASE_MASK;
}


/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_theACLK_GetPhase
********************************************************************************
*
* Summary:
...
{
    return convertidorAnalogicoDigital_theACLK_PHASE & convertidorAnalogicoDigital_theACLK_PHASE_MASK;
}
