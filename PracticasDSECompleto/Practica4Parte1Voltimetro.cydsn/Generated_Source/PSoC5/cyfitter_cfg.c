...
uint8 CYXDATA * const CYCODE convertidorAnalogicoDigital_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE convertidorAnalogicoDigital_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void convertidorAnalogicoDigital_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*convertidorAnalogicoDigital_AMux__addrTable[channel] |= convertidorAnalogicoDigital_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: convertidorAnalogicoDigital_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void convertidorAnalogicoDigital_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*convertidorAnalogicoDigital_AMux__addrTable[channel] &= (uint8)~convertidorAnalogicoDigital_AMux__maskTable[channel];
	}
}
