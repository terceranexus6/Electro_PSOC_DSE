// ======================================================================
// Practica4Parte1Voltimetro.v generated from TopDesign.cysch
// 05/13/2017 at 21:56
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b657c696-8e72-4692-8e9f-903189a4369e/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    ADC_DelSig_v3_20_0 convertidorAnalogicoDigital (
        .vplus(Net_8),
        .vminus(Net_1),
        .soc(1'b1),
        .eoc(Net_3),
	...
	wire [0:0] tmpOE__entradaMedicion_net;
	wire [0:0] tmpFB_0__entradaMedicion_net;
	wire [0:0] tmpIO_0__entradaMedicion_net;
	wire [0:0] tmpINTERRUPT_0__entradaMedicion_net;
	electrical [0:0] tmpSIOVREF__entradaMedicion_net;
	...
	cy_psoc3_pins_v1_10
		...
		entradaMedicion
		 (.oe(tmpOE__entradaMedicion_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__entradaMedicion_net[0:0]}),
		  .analog({Net_8}),
		  .io({tmpIO_0__entradaMedicion_net[0:0]}),
		  .siovref(tmpSIOVREF__entradaMedicion_net),
		  .interrupt({tmpINTERRUPT_0__entradaMedicion_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__entradaMedicion_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    CharLCD_v2_20_1 pantallaLCD ();
