...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("71305f2c-8d0d-4bd8-afd0-6f98713f6f7a/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    assign Net_3 = Net_1 ^ Net_2;

	wire [0:0] tmpOE__entradaA_net;
	wire [0:0] tmpIO_0__entradaA_net;
	wire [0:0] tmpINTERRUPT_0__entradaA_net;
	electrical [0:0] tmpSIOVREF__entradaA_net;
	...
	cy_psoc3_pins_v1_10
		...
		entradaA
		 (.oe(tmpOE__entradaA_net),
		  .y({1'b0}),
		  .fb({Net_1}),
		  .io({tmpIO_0__entradaA_net[0:0]}),
		  .siovref(tmpSIOVREF__entradaA_net),
		  .interrupt({tmpINTERRUPT_0__entradaA_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__entradaA_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__entradaB_net;
	wire [0:0] tmpIO_0__entradaB_net;
	wire [0:0] tmpINTERRUPT_0__entradaB_net;
	electrical [0:0] tmpSIOVREF__entradaB_net;

	cy_psoc3_pins_v1_10
		#(.id("a13872bb-4ad3-4dce-bb54-11ae38329506"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		entradaB
		 (.oe(tmpOE__entradaB_net),
		  .y({1'b0}),
		  .fb({Net_2}),
		  .io({tmpIO_0__entradaB_net[0:0]}),
		  .siovref(tmpSIOVREF__entradaB_net),
		  .interrupt({tmpINTERRUPT_0__entradaB_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__entradaB_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
