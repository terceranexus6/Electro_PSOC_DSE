...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3fa297ae-69fc-4382-a4c9-f3671d848042/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    EdgeDetect_v1_0 detector (
        .d(Net_90),
        .det(Net_84),
        .clock(Net_75));
    defparam detector.EdgeType = 1;

    BasicCounter_v1_0 contador (
        .en(Net_84),
        .cnt(Net_74[7:0]),
        .reset(Net_7),
        .clock(Net_75));
    defparam contador.Width = 8;

    CyStatusReg_v1_90 registro (
        .status_0(1'b0),
        .status_1(1'b0),
        .status_2(1'b0),
        .status_3(1'b0),
    ...
    defparam registro.BusDisplay = 1;
    defparam registro.Interrupt = 0;
    defparam registro.MaskValue = 0;
    defparam registro.NumInputs = 8;

    CharLCD_v2_20_0 pantallaLCD ();

    assign Net_7 = (Net_19[7:0] == Net_74[7:0]);
