...
#define interrupcionDelPWM_INTC_VECTOR            ((reg32 *) interrupcionDelPWM__INTC_VECT)
...
#define interrupcionDelPWM_INTC_SET_EN            ((reg32 *) interrupcionDelPWM__INTC_SET_EN_REG)

/* Address of the INTC.CLR_EN[x] register to bit clear the interrupcionDelPWM interrupt. */
#define interrupcionDelPWM_INTC_CLR_EN            ((reg32 *) interrupcionDelPWM__INTC_CLR_EN_REG)

/* Address of the INTC.SET_PD[x] register to set the interrupcionDelPWM interrupt state to pending. */
#define interrupcionDelPWM_INTC_SET_PD            ((reg32 *) interrupcionDelPWM__INTC_SET_PD_REG)

/* Address of the INTC.CLR_PD[x] register to clear the interrupcionDelPWM interrupt. */
#define interrupcionDelPWM_INTC_CLR_PD            ((reg32 *) interrupcionDelPWM__INTC_CLR_PD_REG)
