...
/* leyendoDelUSB */
#define leyendoDelUSB__0__INTTYPE CYREG_PICU1_INTTYPE5
#define leyendoDelUSB__0__MASK 0x20u
#define leyendoDelUSB__0__PC CYREG_PRT1_PC5
#define leyendoDelUSB__0__PORT 1u
#define leyendoDelUSB__0__SHIFT 5u
#define leyendoDelUSB__AG CYREG_PRT1_AG
#define leyendoDelUSB__AMUX CYREG_PRT1_AMUX
#define leyendoDelUSB__BIE CYREG_PRT1_BIE
#define leyendoDelUSB__BIT_MASK CYREG_PRT1_BIT_MASK
#define leyendoDelUSB__BYP CYREG_PRT1_BYP
#define leyendoDelUSB__CTL CYREG_PRT1_CTL
#define leyendoDelUSB__DM0 CYREG_PRT1_DM0
#define leyendoDelUSB__DM1 CYREG_PRT1_DM1
#define leyendoDelUSB__DM2 CYREG_PRT1_DM2
#define leyendoDelUSB__DR CYREG_PRT1_DR
#define leyendoDelUSB__INP_DIS CYREG_PRT1_INP_DIS
#define leyendoDelUSB__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define leyendoDelUSB__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define leyendoDelUSB__LCD_EN CYREG_PRT1_LCD_EN
#define leyendoDelUSB__MASK 0x20u
#define leyendoDelUSB__PORT 1u
#define leyendoDelUSB__PRT CYREG_PRT1_PRT
#define leyendoDelUSB__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define leyendoDelUSB__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define leyendoDelUSB__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define leyendoDelUSB__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define leyendoDelUSB__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define leyendoDelUSB__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define leyendoDelUSB__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define leyendoDelUSB__PS CYREG_PRT1_PS
#define leyendoDelUSB__SHIFT 5u
#define leyendoDelUSB__SLW CYREG_PRT1_SLW

/* interrupcionDMA */
#define interrupcionDMA__0__INTTYPE CYREG_PICU2_INTTYPE7
#define interrupcionDMA__0__MASK 0x80u
#define interrupcionDMA__0__PC CYREG_PRT2_PC7
#define interrupcionDMA__0__PORT 2u
#define interrupcionDMA__0__SHIFT 7u
#define interrupcionDMA__AG CYREG_PRT2_AG
#define interrupcionDMA__AMUX CYREG_PRT2_AMUX
#define interrupcionDMA__BIE CYREG_PRT2_BIE
#define interrupcionDMA__BIT_MASK CYREG_PRT2_BIT_MASK
#define interrupcionDMA__BYP CYREG_PRT2_BYP
#define interrupcionDMA__CTL CYREG_PRT2_CTL
#define interrupcionDMA__DM0 CYREG_PRT2_DM0
#define interrupcionDMA__DM1 CYREG_PRT2_DM1
#define interrupcionDMA__DM2 CYREG_PRT2_DM2
#define interrupcionDMA__DR CYREG_PRT2_DR
#define interrupcionDMA__INP_DIS CYREG_PRT2_INP_DIS
#define interrupcionDMA__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU2_BASE
#define interrupcionDMA__LCD_COM_SEG CYREG_PRT2_LCD_COM_SEG
#define interrupcionDMA__LCD_EN CYREG_PRT2_LCD_EN
#define interrupcionDMA__MASK 0x80u
#define interrupcionDMA__PORT 2u
#define interrupcionDMA__PRT CYREG_PRT2_PRT
#define interrupcionDMA__PRTDSI__CAPS_SEL CYREG_PRT2_CAPS_SEL
#define interrupcionDMA__PRTDSI__DBL_SYNC_IN CYREG_PRT2_DBL_SYNC_IN
#define interrupcionDMA__PRTDSI__OE_SEL0 CYREG_PRT2_OE_SEL0
#define interrupcionDMA__PRTDSI__OE_SEL1 CYREG_PRT2_OE_SEL1
#define interrupcionDMA__PRTDSI__OUT_SEL0 CYREG_PRT2_OUT_SEL0
#define interrupcionDMA__PRTDSI__OUT_SEL1 CYREG_PRT2_OUT_SEL1
#define interrupcionDMA__PRTDSI__SYNC_OUT CYREG_PRT2_SYNC_OUT
#define interrupcionDMA__PS CYREG_PRT2_PS
#define interrupcionDMA__SHIFT 7u
#define interrupcionDMA__SLW CYREG_PRT2_SLW

/* outindexinIndex */
#define outindexinIndex__0__INTTYPE CYREG_PICU1_INTTYPE6
#define outindexinIndex__0__MASK 0x40u
#define outindexinIndex__0__PC CYREG_PRT1_PC6
#define outindexinIndex__0__PORT 1u
#define outindexinIndex__0__SHIFT 6u
#define outindexinIndex__AG CYREG_PRT1_AG
#define outindexinIndex__AMUX CYREG_PRT1_AMUX
#define outindexinIndex__BIE CYREG_PRT1_BIE
#define outindexinIndex__BIT_MASK CYREG_PRT1_BIT_MASK
#define outindexinIndex__BYP CYREG_PRT1_BYP
#define outindexinIndex__CTL CYREG_PRT1_CTL
#define outindexinIndex__DM0 CYREG_PRT1_DM0
#define outindexinIndex__DM1 CYREG_PRT1_DM1
#define outindexinIndex__DM2 CYREG_PRT1_DM2
#define outindexinIndex__DR CYREG_PRT1_DR
#define outindexinIndex__INP_DIS CYREG_PRT1_INP_DIS
#define outindexinIndex__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define outindexinIndex__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define outindexinIndex__LCD_EN CYREG_PRT1_LCD_EN
#define outindexinIndex__MASK 0x40u
#define outindexinIndex__PORT 1u
#define outindexinIndex__PRT CYREG_PRT1_PRT
#define outindexinIndex__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define outindexinIndex__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define outindexinIndex__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define outindexinIndex__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define outindexinIndex__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define outindexinIndex__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define outindexinIndex__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define outindexinIndex__PS CYREG_PRT1_PS
#define outindexinIndex__SHIFT 6u
#define outindexinIndex__SLW CYREG_PRT1_SLW
