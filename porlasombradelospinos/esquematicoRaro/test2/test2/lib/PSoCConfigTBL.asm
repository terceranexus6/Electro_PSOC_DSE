...
export LoadConfigTBL_test2_Bank1
export LoadConfigTBL_test2_Bank0
export LoadConfigTBL_test2_Ordered
AREA lit(rom, rel)
LoadConfigTBL_test2_Bank0:
...
;       Instance name ADCINC, Block Name ADC1(ASC10)
	...
	db		83h, f0h		;ADCINC_AtoD1cr3(ASC10CR3)
...
;       Instance name ADCINC, Block Name PWM(DBB01)
	db		27h, 00h		;ADCINC_PWMcr0(DBB01CR0)
	db		25h, 00h		;ADCINC_PWMdr1(DBB01DR1)
	db		26h, 01h		;ADCINC_PWMdr2(DBB01DR2)
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_test2_Bank1:
;  Instance name ADCINC, User Module ADCINC
;       Instance name ADCINC, Block Name ADC1(ASC10)
;       Instance name ADCINC, Block Name ADC2(ASD20)
;       Instance name ADCINC, Block Name PWM(DBB01)
	db		24h, 31h		;ADCINC_PWMfn(DBB01FN)
	db		25h, 15h		;ADCINC_PWMsl(DBB01IN)
	db		26h, 40h		;ADCINC_PWMos(DBB01OU)
;  Instance name LED, User Module LED
;  Instance name PGA_1, User Module PGA
;       Instance name PGA_1, Block Name GAIN(ACB00)
;  Instance name UART, User Module UART
...
LoadConfigTBL_test2_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 20h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
