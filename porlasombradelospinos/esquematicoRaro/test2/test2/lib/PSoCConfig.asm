...
export LoadConfig_test2
export _LoadConfig_test2
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_Data_SHADE], 20h

	lcall	LoadConfig_test2
	lcall	LoadConfigTBL_test2_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration test2
;
;    Load configuration registers for test2.
...
_LoadConfig_test2:
 LoadConfig_test2:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_test2_Bank0
    mov     X, <LoadConfigTBL_test2_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_test2_Bank1
    mov     X, <LoadConfigTBL_test2_Bank1
