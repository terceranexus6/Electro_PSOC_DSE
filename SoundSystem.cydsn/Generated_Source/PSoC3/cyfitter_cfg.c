...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG0_CFG0), 0x02EDu);
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_REG8((void CYXDATA *)CYREG_PRT1_AMUX, 0x80u);
	CY_SET_REG8((void CYXDATA *)CYREG_DAC1_SW3, 0x01u);
