...
/* Speaker */
#define Speaker__0__INTTYPE CYREG_PICU0_INTTYPE2
#define Speaker__0__MASK 0x04u
#define Speaker__0__PC CYREG_PRT0_PC2
#define Speaker__0__PORT 0u
#define Speaker__0__SHIFT 2u
...
#define Speaker__SHIFT 2u
#define Speaker__SLW CYREG_PRT0_SLW

/* VDACoutDMA */
#define VDACoutDMA__DRQ_CTL CYREG_IDMUX_DRQ_CTL0
#define VDACoutDMA__DRQ_NUMBER 0u
#define VDACoutDMA__NUMBEROF_TDS 0u
#define VDACoutDMA__PRIORITY 7u
#define VDACoutDMA__TERMIN_EN 0u
#define VDACoutDMA__TERMIN_SEL 0u
#define VDACoutDMA__TERMOUT0_EN 1u
#define VDACoutDMA__TERMOUT0_SEL 0u
#define VDACoutDMA__TERMOUT1_EN 0u
#define VDACoutDMA__TERMOUT1_SEL 0u

/* VDACoutDMA_done_isr */
#define VDACoutDMA_done_isr__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define VDACoutDMA_done_isr__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define VDACoutDMA_done_isr__INTC_MASK 0x01u
#define VDACoutDMA_done_isr__INTC_NUMBER 0u
#define VDACoutDMA_done_isr__INTC_PRIOR_NUM 0u
#define VDACoutDMA_done_isr__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define VDACoutDMA_done_isr__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define VDACoutDMA_done_isr__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* leyendoDelUSB */
#define leyendoDelUSB__0__INTTYPE CYREG_PICU4_INTTYPE4
#define leyendoDelUSB__0__MASK 0x10u
#define leyendoDelUSB__0__PC CYREG_PRT4_PC4
#define leyendoDelUSB__0__PORT 4u
#define leyendoDelUSB__0__SHIFT 4u
#define leyendoDelUSB__AG CYREG_PRT4_AG
#define leyendoDelUSB__AMUX CYREG_PRT4_AMUX
#define leyendoDelUSB__BIE CYREG_PRT4_BIE
#define leyendoDelUSB__BIT_MASK CYREG_PRT4_BIT_MASK
#define leyendoDelUSB__BYP CYREG_PRT4_BYP
#define leyendoDelUSB__CTL CYREG_PRT4_CTL
#define leyendoDelUSB__DM0 CYREG_PRT4_DM0
#define leyendoDelUSB__DM1 CYREG_PRT4_DM1
#define leyendoDelUSB__DM2 CYREG_PRT4_DM2
#define leyendoDelUSB__DR CYREG_PRT4_DR
#define leyendoDelUSB__INP_DIS CYREG_PRT4_INP_DIS
#define leyendoDelUSB__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU4_BASE
#define leyendoDelUSB__LCD_COM_SEG CYREG_PRT4_LCD_COM_SEG
#define leyendoDelUSB__LCD_EN CYREG_PRT4_LCD_EN
#define leyendoDelUSB__MASK 0x10u
#define leyendoDelUSB__PORT 4u
#define leyendoDelUSB__PRT CYREG_PRT4_PRT
#define leyendoDelUSB__PRTDSI__CAPS_SEL CYREG_PRT4_CAPS_SEL
#define leyendoDelUSB__PRTDSI__DBL_SYNC_IN CYREG_PRT4_DBL_SYNC_IN
#define leyendoDelUSB__PRTDSI__OE_SEL0 CYREG_PRT4_OE_SEL0
#define leyendoDelUSB__PRTDSI__OE_SEL1 CYREG_PRT4_OE_SEL1
#define leyendoDelUSB__PRTDSI__OUT_SEL0 CYREG_PRT4_OUT_SEL0
#define leyendoDelUSB__PRTDSI__OUT_SEL1 CYREG_PRT4_OUT_SEL1
#define leyendoDelUSB__PRTDSI__SYNC_OUT CYREG_PRT4_SYNC_OUT
#define leyendoDelUSB__PS CYREG_PRT4_PS
#define leyendoDelUSB__SHIFT 4u
#define leyendoDelUSB__SLW CYREG_PRT4_SLW

/* interrupcionDMA */
#define interrupcionDMA__0__INTTYPE CYREG_PICU0_INTTYPE0
#define interrupcionDMA__0__MASK 0x01u
#define interrupcionDMA__0__PC CYREG_PRT0_PC0
#define interrupcionDMA__0__PORT 0u
#define interrupcionDMA__0__SHIFT 0u
#define interrupcionDMA__AG CYREG_PRT0_AG
#define interrupcionDMA__AMUX CYREG_PRT0_AMUX
#define interrupcionDMA__BIE CYREG_PRT0_BIE
#define interrupcionDMA__BIT_MASK CYREG_PRT0_BIT_MASK
#define interrupcionDMA__BYP CYREG_PRT0_BYP
#define interrupcionDMA__CTL CYREG_PRT0_CTL
#define interrupcionDMA__DM0 CYREG_PRT0_DM0
#define interrupcionDMA__DM1 CYREG_PRT0_DM1
#define interrupcionDMA__DM2 CYREG_PRT0_DM2
#define interrupcionDMA__DR CYREG_PRT0_DR
#define interrupcionDMA__INP_DIS CYREG_PRT0_INP_DIS
#define interrupcionDMA__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define interrupcionDMA__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define interrupcionDMA__LCD_EN CYREG_PRT0_LCD_EN
#define interrupcionDMA__MASK 0x01u
#define interrupcionDMA__PORT 0u
#define interrupcionDMA__PRT CYREG_PRT0_PRT
#define interrupcionDMA__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define interrupcionDMA__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define interrupcionDMA__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define interrupcionDMA__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define interrupcionDMA__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define interrupcionDMA__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define interrupcionDMA__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define interrupcionDMA__PS CYREG_PRT0_PS
#define interrupcionDMA__SHIFT 0u
#define interrupcionDMA__SLW CYREG_PRT0_SLW

/* outindexinIndex */
#define outindexinIndex__0__INTTYPE CYREG_PICU4_INTTYPE3
#define outindexinIndex__0__MASK 0x08u
#define outindexinIndex__0__PC CYREG_PRT4_PC3
#define outindexinIndex__0__PORT 4u
#define outindexinIndex__0__SHIFT 3u
#define outindexinIndex__AG CYREG_PRT4_AG
#define outindexinIndex__AMUX CYREG_PRT4_AMUX
#define outindexinIndex__BIE CYREG_PRT4_BIE
#define outindexinIndex__BIT_MASK CYREG_PRT4_BIT_MASK
#define outindexinIndex__BYP CYREG_PRT4_BYP
#define outindexinIndex__CTL CYREG_PRT4_CTL
#define outindexinIndex__DM0 CYREG_PRT4_DM0
#define outindexinIndex__DM1 CYREG_PRT4_DM1
#define outindexinIndex__DM2 CYREG_PRT4_DM2
#define outindexinIndex__DR CYREG_PRT4_DR
#define outindexinIndex__INP_DIS CYREG_PRT4_INP_DIS
#define outindexinIndex__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU4_BASE
#define outindexinIndex__LCD_COM_SEG CYREG_PRT4_LCD_COM_SEG
#define outindexinIndex__LCD_EN CYREG_PRT4_LCD_EN
#define outindexinIndex__MASK 0x08u
#define outindexinIndex__PORT 4u
#define outindexinIndex__PRT CYREG_PRT4_PRT
#define outindexinIndex__PRTDSI__CAPS_SEL CYREG_PRT4_CAPS_SEL
#define outindexinIndex__PRTDSI__DBL_SYNC_IN CYREG_PRT4_DBL_SYNC_IN
#define outindexinIndex__PRTDSI__OE_SEL0 CYREG_PRT4_OE_SEL0
#define outindexinIndex__PRTDSI__OE_SEL1 CYREG_PRT4_OE_SEL1
#define outindexinIndex__PRTDSI__OUT_SEL0 CYREG_PRT4_OUT_SEL0
#define outindexinIndex__PRTDSI__OUT_SEL1 CYREG_PRT4_OUT_SEL1
#define outindexinIndex__PRTDSI__SYNC_OUT CYREG_PRT4_SYNC_OUT
#define outindexinIndex__PS CYREG_PRT4_PS
#define outindexinIndex__SHIFT 3u
#define outindexinIndex__SLW CYREG_PRT4_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 64000000U
#define BCLK__BUS_CLK__KHZ 64000U
#define BCLK__BUS_CLK__MHZ 64U
#define CY_PROJECT_NAME "SoundSystem"
